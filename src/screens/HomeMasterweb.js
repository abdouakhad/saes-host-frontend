    ...
    <div className='bg-gray-50'>
      <div className='relative flex flex-col px-8 sm:px-4 w-full h-screen bg-gradient-to-b from-black to-master_blue lg:flex-row lg:items-center'>
        <div className='text-3xl md:text-6xl font-extrabold tracking-tight mt-16 mb-2 lg:-mt-20 lg:w-2/5 lg:pl-8'>
          ...
          <div
            className='w-1/5 h-1 bg-master_blue -mt-2 mb-4'
            aria-hidden='true'
          />
          <p className='text-master_blue lg:text-gray-200 text-lg font-medium leading-relaxed w-4/5'>
            ...
            quia iure obcaecati aperiam dolor ipsa! Neque architecto ut magnam.
          </p>
      ...
      <div id='id_next' className='relative pt-6 px-4 h-auto md:h-full'>
        <div className='text-center w-full py-4'>
          <span className='text-master_blue font-extrabold text-3xl md:text-5xl block tracking-wide mb-4'>
            What we build
          </span>
          ...
          <div className='grid grid-flow-row w-full lg:w-2/5 md:w-4/5 mx-auto'>
            <div className='flex space-x-4 items-start m-4'>
              ...
              <div className='text-sm md:text-base text-gray-800'>
                <h1 className='font-extrabold text-lg uppercase tracking-wide text-master_blue'>
                  Web
                </h1>
            ...
            <div className='flex space-x-4 items-start m-4'>
              ...
              <div className='text-sm md:text-base text-gray-800'>
                ...
                assumenda harum suscipit, laudantium excepturi accusantium nihil
                explicabo mollitia quam reprehenderit!
              </div>
            </div>
            <div className='flex space-x-4 items-start m-4'>
              <div>
              ...
              <div className='text-sm md:text-base text-gray-800'>
                ...
                Nostrum enim natus voluptas explicabo, laudantium voluptatibus.
              </div>
            </div>
          </div>
      ...
      <div className='flex flex-col px-4 m-4 h-full relative'>
        <div className='w-full md:w-4/5 ml-0 h-auto text-lg sm:text-2xl font-medium leading-8 tracking-wide text-gray-600 my-8'>
          ...
          <p className='mb-2'>
            ...
            ducimus repellat possimus culpa dolore voluptate?
          </p>
        </div>
          ...
          <div className='flex flex-col md:flex-row md:justify-between md:items-center md:w-full md:mx-auto my-4'>
            <div className='flex space-x-4 items-start m-4 md:flex-col md:space-x-0 md:space-y-2 md:p-2'>
              ...
              <div className='text-base font-medium text-gray-800'>
                <h1 className='font-extrabold text-lg capitalize tracking-tight text-master_blue'>
                  Stability
                </h1>
        ...
        <div className='flex flex-col h-auto md:flex-row md:items-center mt-16 lg:mt-0 min-h-screen'>
          <div className='font-bold text-gray-600 w-full lg:w-3/5 md:w-2/4 md:-mt-20'>
            <h1 className='font-extrabold capitalize text-3xl sm:text-5xl text-master_blue mb-4 tracking-tight'>
              Why us ?
            </h1>
            <p className='mb-4 mt-8 leading-8 text-lg sm:text-2xl tracking-wide'>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime
              obcaecati praesentium quod vel! Ducimus harum rem in.
            </p>
            <p className='my-4 leading-8 text-lg sm:text-2xl tracking-wide'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consequatur in quia laborum tempora itaque aspernatur facilis
              nobis possimus, iusto ab nemo saepe odio maxime ullam.
            </p>
          </div>
            ...
            <div className='mt-8'>
                ...
                <div class='relative'>
                  ...
                  <div className='lg:mx-4'>
                    <div class='relative bg-white rounded-xl shadow-lg p-4'>
                      <h1 className='text-xl uppercase font-extrabold lg:text-3xl text-center py-2'>
                        Affordable
                      </h1>
                      <p className='leading-relaxed'>
                        Lorem ipsum dolor sit amet consectetur, adipisicing
                        elit. Earum dicta consectetur vero cum similique sit.
                        Fugit earum itaque aut tempore illum nemo aliquam sunt
                        eaque ipsa, commodi optio exercitationem excepturi
                        eveniet harum veritatis amet quidem repudiandae enim
                        eius distinctio ipsam.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Tab.Panel className='w-full max-w-screen-lg mx-auto bg-transparent text-black px-4 py-2'>
                <div class='relative'>
                  ...
                  <div className='lg:mx-4'>
                    <div class='relative bg-white rounded-xl shadow-lg p-4'>
                      <h1 className='text-xl font-extrabold uppercase lg:text-3xl text-center py-2'>
                        Fast
                      </h1>
                      <p className='leading-relaxed'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Maiores reprehenderit cupiditate, blanditiis vitae
                        facilis eveniet vel sunt eligendi eos cumque repellat
                        atque tempora assumenda asperiores!
                      </p>
                      <ul class='list-disc space-y-2 mt-2'>
                        <li class='flex items-start'>
                          <span class='h-6 flex items-center sm:h-7'>
                            <svg
                              class='flex-shrink-0 h-5 w-5 text-master_blue'
                              viewBox='0 0 20 20'
                              fill='currentColor'
                            >
                              <path
                          ...
                          <p class='ml-2 font-medium'>Prototype</p>
                        </li>
                        <li class='flex items-start'>
                          <span class='h-6 flex items-center sm:h-7'>
                            <svg
                          ...
                          <p class='ml-2 font-medium'>Brainstorm</p>
                        </li>
                        <li class='flex items-start'>
                          <span class='h-6 flex items-center sm:h-7'>
                            <svg
                          ...
                          <p class='ml-2 font-medium'>Design & Wireframe</p>
                        </li>
                      </ul>
              ...
              <Tab.Panel className='w-full max-w-screen-lg mx-auto bg-transparent text-black px-4 py-2'>
                <div class='relative'>
                  ...
                  <div className='lg:mx-4'>
                    <div class='relative bg-white rounded-xl shadow-lg p-4'>
                      <h1 className='text-xl font-extrabold lg:text-3xl text-center py-2'>
                        Team
                      </h1>
                ...
                <div class='relative'>
                  ...
                  <div className='lg:mx-4'>
                    <div class='relative bg-white rounded-xl shadow-lg p-4'>
                      ...
                      <p className='leading-relaxed'>
                        <span className='font-extrabold text-master_blue text-xl block capitalize'>
                          Lorem ipsum dolor sit amet,
                        </span>{' '}
                        consectetur adipisicing elit. Maxime reiciendis sit
                        tenetur corrupti, minima sunt omnis quo blanditiis,
                        fugiat est mollitia itaque repellendus enim cumque eos.
                        Possimus aspernatur rerum magnam ullam. Laudantium quo
                        esse tempore?
                      </p>
                    ...
                    <div class='relative bg-white rounded-xl shadow-lg p-4'>
                      ...
                      <div className='flex flex-col md:flex-row md:justify-between m-2 md:items-center'>
                        <div className='lg:w-2/3 md:w-2/4'>
                          <span className='font-bold text-3xl text-master_blue tracking-tight mb-1 block'>
                            Time matters
                          </span>
                          <p className='leading-relaxed text-sm lg:text-lg'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Veritatis veniam accusantium recusandae
                            inventore enim, aliquam pariatur cupiditate
                            dignissimos sequi amet aspernatur magnam minus
                            suscipit cum.
                          </p>
                        </div>
      ...
      <div className='w-full mt-16 mx-auto h-full min-h-screen'>
        <div className='w-11/12 md:w-4/5 mx-auto md:ml-16 h-auto text-lg sm:text-2xl font-medium leading-8 tracking-wide text-gray-600 my-8'>
          ...
          <p className='mt-8 mb-2'>
            ...
            consequuntur voluptas, vel nesciunt harum omnis aut porro et unde
            vero!
          </p>
          <p className='mb-2'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione
      ...
      <div className='w-full h-full mx-4 mt-16 min-h-screen'>
        <div className='w-11/12 md:w-4/5 mx-auto md:ml-16 h-auto text-lg sm:text-2xl font-medium leading-8 tracking-wide text-gray-600 my-10'>
          ...
          <p className='mt-8 mb-2'>
            ...
            nam itaque ullam repudiandae praesentium voluptate explicabo
            repellendus doloribus voluptates?
          </p>
        </div>
      ...
      <div className='w-11/12 p-4 mx-auto'>
        <div className='w-full md:w-4/5  h-auto text-lg sm:text-2xl font-medium leading-8 tracking-wide text-gray-600 my-8'>
          ...
          <p className='mt-8 mb-2'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore,
            dicta voluptatem reiciendis culpa earum illo.
          </p>
        </div>
