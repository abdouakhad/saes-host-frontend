...
const imgs = [service0, service1, service2, service3]

const p1 = 'Lorem ipsumLorem ipsum dolor sit amet, Infography elit, sed do eiusmod Logo incididunt ut la.'

function Services(){
    return (
        <div className="page3 my-5">
            <div class="bg-black text-white py-8 text-center">
                <h1 class='text-3xl font-bold special'>
                    Our Services
                </h1>
            </div>
